...
public class BinaryUtilsUnitTest {
    ...
    public void testXor()
    {
        ...
        assertArrayEquals(xorResult, expectedXorResult);
    ...
    public void testHigherBinaryArray()
    {
        ...
        assertEquals(BinaryUtils.getHigherByteArray(val1, val1), 0);
        assertEquals(BinaryUtils.getHigherByteArray(val1, val2), 1);
        assertEquals(BinaryUtils.getHigherByteArray(val2, val1), 2);
        assertEquals(BinaryUtils.getHigherByteArray(val2, val3), 1);
        assertEquals(BinaryUtils.getHigherByteArray(val4, val2), 1);
        assertEquals(BinaryUtils.getHigherByteArray(val4, val1), 2);
    }
}
