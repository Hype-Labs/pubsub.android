...
{
    static public final String HPB_APP_IDENTIFIER = "db2b109d";
    static public final String HPB_HASH_ALGORITHM = "SHA-1";
    ...
    static public final String GLOBAL_TAG_PREFIX = "HpbApplication-";
